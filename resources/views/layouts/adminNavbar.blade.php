        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/admin" class="flex ms-2 md:me-24">
                    <img src="{{ asset('img/logo4U.jpg') }}" class="h-8 me-3" alt="FlowBite Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">ForYou.Corp</span>
                </a>
            </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('desain.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Desain Products</span>
                </a>
            </li>
            <li>
                <a href="{{ route('prouser.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Customer's Product</span>
                </a>
            </li>
            <li>
