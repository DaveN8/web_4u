            ...
            <div class="py-16 bg-white overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <p class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Introducing Banner4U</p>
                        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">For you adalah bisnis undangan digital yang
                            menawarkan layanan pembuatan undangan digital yang praktis, cepat, dan menarik. Bisnis ini memiliki
                            ...
                            lingkungan. Dengan layanan yang efisien dan berkualitas, Foryou merupakan pilihan yang sempurna bagi
                    ...
                    <div class="mt-16 flex justify-center">
                        <div class="max-w-full space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                            <div class="relative" id="affordable">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">Hadirkan keindahan ke dalam undangan Anda tanpa
                                    mengorbankan kantong Anda. 4U E-Invitation menghadirkan sentuhan elegan dengan harga yang
                            ...
                            <div class="relative" id="customizable">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">Kami memahami bahwa setiap acara adalah cerita
                                    unik. Dengan 4U E-Invitation, Anda dapat mengubah undangan Anda sesuai dengan keinginan Anda.
                                    Pilih warna, gaya, dan detail lainnya untuk menciptakan undangan yang benar-benar mencerminkan
                                    Anda.</dd>
                            </div>
                            ...
                            <div class="relative" id="reusable">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">Kami merayakan momen istimewa dengan memberikan
                                    cinta pada lingkungan. 4U E-Invitation tidak hanya indah, tetapi juga ramah lingkungan. Pilih
