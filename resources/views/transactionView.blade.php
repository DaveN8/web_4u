    ...
    @section('admin_content')
        ...
        <div class="h-full w-full">
            ...
            for="file_input">Upload file</label> --}}
                                            ...
                                            <form method="POST" action="{{ route('transaction.update', $tsc->id) }}"
                                                ...
                                                <input type="hidden" name="id_transaction" value="{{ $tsc['id'] }}">
                                                <button type="submit"
                                ...
                                <div class="rounded-lg md:w-2/3 h-fit bg-white shadow-md">
                                    ...
                                    <div class="flex justify-between gap-x-6 p-6">
                                        ...
                                        <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                            ...
                                            @elseif ($tsc['statusTransaction'] == 'done')
                                                <p class="mt-1 text-xl leading-5 text-green-500">
                                                    {{ $tsc['statusTransaction'] }}
                                                </p>
                                            @endif
                                    ...
                                    <div class="grid p-6 pt-0">
                                        ...
                                        @elseif ($tsc['statusTransaction'] == 'approved')
                                            <form action="{{ route('transaction.update', $tsc['id']) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('PATCH')
                                                <input type="hidden" name="statusTransaction" value="done">
