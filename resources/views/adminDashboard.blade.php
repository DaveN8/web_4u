                                    ...
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            {{-- @foreach ($productCount as $pcount) --}}
                                                <h4 class="text-2xl font-semibold text-gray-700">{{ $packageCount }}</h4>
                                            {{-- @endforeach --}}
                                        ...
                                        @foreach ($user as $us)
                                            <tbody class="bg-white">
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <span
                                                            class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-full">{{ $us['role'] }}</span>
                                                    </td>
